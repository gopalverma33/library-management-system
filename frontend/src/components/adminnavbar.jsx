          ...
          {role == "admin" ? (
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="membershipDropdown">
                <li>
                  <Link className="dropdown-item" to="/admin/membership/add">Add Membership</Link>
                </li>
                <li>
                  <Link className="dropdown-item" to="/admin/membership/manage">Manage Membership</Link>
                </li>
              </ul>
            </li>
          ) : null}
