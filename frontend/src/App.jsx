...
function App() {
  ...
  <Route path='membership/manage' element={<ManageMembership />} />

</Route>
        <Route path='/user' element={<Userlayout/>}>
          <Route index element={<ProfilePage/>}/>         
        </Route>
        <Route path='/membership/add' element={<Navigate to="/admin/membership/add" replace />} />
        <Route path='/membership/manage' element={<Navigate to="/admin/membership/manage" replace />} />
