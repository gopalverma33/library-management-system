        ...
        <nav className="col-md-3 col-lg-2 admin-sidebar">
          ...
          <ul className="admin-nav">
            ...
            {role === "admin" && (
              <>
                <li className="admin-nav-item">
                  <Link className="admin-nav-link" to="/admin/membership/add">
                    ➕ Add Membership
                  </Link>
                </li>
                <li className="admin-nav-item">
                  <Link className="admin-nav-link" to="/admin/membership/manage">
                    🪪 Manage Membership
                  </Link>
                </li>
              </>
                      ...
                      latestBooks.slice(0, 4).map((book, index) => (
                        <div key={index} className="activity-item">
                          ...
                          <div className="activity-text">
                            <strong>{book.title}</strong> added by {book.addedBy?.name || "Unknown"}
                          </div>
                        </div>
                      ))
                    ) : (
                      <p className="empty-state">No recent books found.</p>
                    )}
                  </div>
                </div>
              </div>
